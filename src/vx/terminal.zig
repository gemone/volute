// Backward-compat shim — actual implementation in src/tui/terminal.zig
const nc_terminal = @import("../tui/terminal.zig");
...
pub const hasInteractiveTty = nc_terminal.hasInteractiveTty;
